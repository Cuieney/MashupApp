        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              ...
              child: GestureDetector(
                onTap: () => NavigatorUtils.pushResult(
                    context, Routers.modifyUserHead, (reslut) {
                  _initUserInfo();
                }),
                child: Center(
                    child: Column(
            ...
            Container(
              ...
              child: InkWell(
                onTap: (){
                  var title = FluroConvertUtils.fluroCnParamsEncode("修改昵称");
                  NavigatorUtils.push(context, "${Routers.modifyUserInfo}?title=${title}&isModifyUserName=true");
                },
                child: Stack(
                  children: <Widget>[
                    Align(
            ...
            Container(
              ...
              child: InkWell(
                  onTap: (){
                    var title = FluroConvertUtils.fluroCnParamsEncode("修改签名");
                    NavigatorUtils.push(context, "${Routers.modifyUserInfo}?title=${title}&isModifyUserName=false");
                  },
                  child: Stack(
                    children: <Widget>[
                      Align(
